			...
			<?php
				...
				{					
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li> <a style="color: orange; font-family: Lucida Bright; font-size: 25px; padding-right: 25px;" href=""><span class="glyphicon glyphicon-user">
							<?php 
				...
				else
				{
					?>
					<ul class="nav navbar-nav navbar-right">
						<li> <a style="color: orange; font-family: Lucida Bright; font-size: 25px; padding-right: 65px;" href="admin.php"><span class="glyphicon glyphicon-log-in"> LOGIN</span></a></li>
					</ul>
					<?php
				}
