...
<body>
	<section>
			...
			<script>
				...
				<div>
					<form class="navbar-form" method="post" name="form1" style="text-align: right; padding-top: 18px; padding-right: 60px;">
						<div>
							<input class="form-control" type="text" name="search" placeholder="  Search for Companies by Name " required="" style="font-family: Lucida Bright; font-size: 18px; height: 49.3px; width: 350px;">
		...
		<?php
			...
			{
				$q = mysqli_query($db, "SELECT * FROM `manufacturer` WHERE name like '%$_POST[search]%';");

				if(mysqli_num_rows($q)==0)
				{
					echo "<p style='color: orange; font-size:30px; text-align: center; font-family: Lucida Bright; padding-top: 0px;'> <strong> <b>Sorry!!! Entry of the Manufacturer has not been found! </b> </strong> </p>";
				}
				...
				else
				{
					echo "<table class='table table-bordered table-hover' >";
						...
						echo "<th style='text-align:center;'>"; echo "Country";  echo "</th>";
						echo "<th style='text-align:center;'>"; echo "Estd. Year";  echo "</th>";
						...
						while($row=mysqli_fetch_assoc($q))
						{
							echo "<tr style='background-color:#ffedc7bd '>";
								...
								echo "<td style='text-align:left; padding-left: 15 px; font-family: Lucida Bright; font-size: 15px; '>"; echo "<p style='padding-left: 15px;'>".$row['country']."</p>" ; echo "</td>";
								echo "<td style='text-align:left; padding-left: 15 px; font-family: Lucida Bright; font-size: 15px; '>"; echo "<p style='padding-left: 15px;'>".$row['year']."</p>" ; echo "</td>";
								...
								echo "<td style='text-align:center; font-family: Lucida Bright; font-size: 15px; '>"; echo $row['contact']; echo "</td>";
			...
			{
				$res=mysqli_query($db, "select * from `manufacturer` order by `manufacturer`.`id`;");
