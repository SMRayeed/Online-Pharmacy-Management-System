            ...
            <form name="registration" action="" method="post" style="color: white;">
              <div class="registration">
                ...
                <div class="reg_button">
                  <input class="btn btn-default" type="submit" name="submit" value="Add to Library"  style="color: black; height: 55px; width: 260px; font-size: 25px; background-color: #e8a23d5e; color: white; font-family: Lucida Bright; ">
                </div>
