		...
		<div id="main">
			...
			<?php
				if(isset($_SESSION['login_user']))
				{
					?>
						<div>
							<form class="navbar-form" method="post" name="form1" style="text-align: right; padding-top: 18px; padding-right: 80px;">
								<div>
									<input class="form-control" type="text" name="search" placeholder="  Search for a  Medicine (Enter Name) ..."  style="font-family: Lucida Bright; font-size: 18px; height: 49.3px; width: 400px;">
									...
									<input class="form-control" type="int" name="id" placeholder="  Delete a  Medicine (Enter ID) ..."  style="font-family: Lucida Bright; font-size: 18px; height: 49.3px; width: 400px; margin-left: 40px;">
									<button class="btn btn-default" type="submit" name="delete" style="background-color: #e8a23d5e; font-size: 25px; ">
										<span class="glyphicon glyphicon-trash" style="color: white; height: 27.5px; "></span>
									</button>
								</div>				
							</form>
						</div>
			...
			<?php
						...
						echo "<table class='table table-bordered table-hover' >";
							...
							while($row=mysqli_fetch_assoc($q))
							{
								echo "<tr style='background-color:#ffedc7bd '>";
									...
									echo "<td style='text-align:left; font-family: Lucida Bright; font-size: 15px; '>"; echo "<p style='padding-left: 15px;'>".$row['manufacturer']."</p>" ; echo "</td>";
									echo "<td style='text-align:center; font-family: Lucida Bright; font-size: 15px; '>"; echo $row['type']; echo "</td>";
									echo "<td style='text-align:center; font-family: Lucida Bright; font-size: 15px; '>"; echo $row['status']; echo "</td>";
									echo "<td style='text-align:center; font-family: Lucida Bright; font-size: 15px; '>"; echo $row['quantity']; echo "</td>";
									echo "<td style='text-align:center; font-family: Lucida Bright; font-size: 15px; '>"; echo $row['cost']; echo "</td>";
								echo "</tr>";
							}
						echo "</table>";
					}
				} elseif(isset($_POST['delete']))
				{
					...
					$del = mysqli_query($db,"SELECT * from medicine where id = '$_POST[id]'; ");
					if(mysqli_num_rows($del)>0)
					{
						mysqli_query($db,"DELETE from medicine where id = '$_POST[id]'; ");
					?>
					...
					else
					{
						?>
							<script type="text/javascript">
								alert("Could not find the Medicine ...");
								window.location = "medicine.php";
							</script>
						<?php
					}
