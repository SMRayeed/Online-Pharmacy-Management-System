...
<html>
					...
					<div class="box2">
						...
						<form name="registration" action="" method="post">
							<div class="registration">
								<input class="form-control" type="int" name="id" placeholder="   Manufacturer ID" required="" style="font-family: Lucida Bright; font-size: 20px; height: 30px; width: 350px;">
								<br>
								<input class="form-control" type="text" name="name" placeholder="   Manufacturer Name" required="" style="font-family: Lucida Bright; font-size: 20px; height: 30px; width: 350px;" >
								<br>
								<input class="form-control" type="text" name="country" placeholder="   Manufacturer's Country" required="" style="font-family: Lucida Bright; font-size: 20px; height: 30px; width: 350px;" >
								<br>
								<input class="form-control" type="int" name="year" placeholder="   Establishment Year" required="" style="font-family: Lucida Bright; font-size: 20px; height: 30px; width: 350px;" >
								<br>
								...
								<br>
								<input class="form-control" type="text" name="contact" placeholder="   Contact No." required="" style="font-family: Lucida Bright; font-size: 20px; height: 30px; width: 350px;" >
								<br>
    ...
    <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        if($count == 0)
        {
          mysqli_query($db,"INSERT INTO `manufacturer` VALUES('$_POST[id]', '$_POST[name]', '$_POST[country]' , '$_POST[year]', '$_POST[email]', '$_POST[contact]', '$_POST[username]', '$_POST[password]');");
        ?>
