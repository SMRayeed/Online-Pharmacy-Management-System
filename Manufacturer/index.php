					...
					if(isset($_SESSION['login_user']))
					{
						...
						<nav>
							<ul>
								...
								<li> <a style="font-family: Lucida Bright; font-size: 20px; color: orange;" href="companieslist.php"><b>Manufacturers</b></a> </li>
						...
						?>
							<nav>
								<ul>
									...
									<li> <a style="font-family: Lucida Bright; font-size: 20px; color: orange;" href="manufacturer.php"><b>LOGIN</b></a> </li>
									<li> <a style="font-family: Lucida Bright; font-size: 20px; color: orange;" href="feedback.php"><b>ABOUT</b></a> </li>
								</ul>
							</nav>
						<?php
