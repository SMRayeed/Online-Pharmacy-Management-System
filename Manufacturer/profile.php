	...
	<div>
 		...
 		<div class="wrapper">
 			<?php
 				...
 				$q=mysqli_query($db,"SELECT * FROM `manufacturer` where username='$_SESSION[login_user]' ;");
 			?>
 			...
 			?>
 			<div style="color: orange; font-size: 25px; font-family: Lucida Bright; ; text-align: center; padding-top: 10px;">
	 				<b><br><br>
	 				<?php 	
 			...
 			<?php
 				...
 				echo "<table style='font-family: Lucida Bright; font-size:20px; background-color: #3e310e75;' class='table table-bordered'>";
					...
					echo "<tr>";
	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>"."Manufacturer ID"."</p>" ; echo "</td>";
	 					echo "</td>";
	 					echo "<td>";
	 				...
	 				echo "<tr>";
	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>"."Manufacturer Name"."</p>" ; echo "</td>";
	 					echo "</td>";
	 				...
	 				echo "<tr>";
	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>"."Manufacturer's Country"."</p>" ; echo "</td>";
	 					echo "</td>";

	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>".$row['country']."</p>" ; echo "</td>";
	 					echo "</td>";
	 				echo "</tr>";

	 				echo "<tr>";
	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>"."Year Established"."</p>" ; echo "</td>";
	 					echo "</td>";

	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>".$row['year']."</p>" ; echo "</td>";
	 					echo "</td>";
	 				echo "</tr>";	 				
	 				...
	 				echo "<tr>";
	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>"."Contact Details"."</p>" ; echo "</td>";
	 					echo "</td>";
	 					echo "<td>";
	 						echo "<p style='padding-left: 15px;'>".$row['contact']."</p>" ; echo "</td>";
	 					echo "</td>";
	 				echo "</tr>";
