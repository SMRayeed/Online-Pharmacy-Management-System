...
<html>
	...
	<body>
				...
				<br>
					<div class="box1">
						...
						<form name="login" action="" method="post">
							<div class="login">
								<input class="form-control" type="text" name="username" placeholder="  Manufacturer Username" required="" style="font-family: Lucida Bright; font-size: 30px; ">
								<br>
								<input class="form-control" type="password" name="password" placeholder="  Manufacturer Password" required="" style="font-family: Lucida Bright; font-size: 30px;" >\
								<br>
		...
		<?php
			...
			{
				$count = 0 ;
				$res = mysqli_query($db, "SELECT * FROM `manufacturer` WHERE username = '$_POST[username]' && password = '$_POST[password]';");
