			...
			<?php
				...
				{					
					...
					<ul style="padding-left: 1px; padding-top: 5px; " class="nav navbar-nav">					
						<li> <a style="font-family: Lucida Bright; font-size: 20px; " href="medicine.php"> <b>MEDICINE</b> </a> </li>
					</ul>
					<ul style="padding-left: 1px; padding-top: 5px; " class="nav navbar-nav">					
						<li> <a style="font-family: Lucida Bright; font-size: 20px; " href="customerslist.php"> <b>CUSTOMER</b> </a> </li>
					</ul>
				...
				else
				{
					...
					<ul class="nav navbar-nav navbar-right">
						<li> <a style="color: orange; font-family: Lucida Bright; font-size: 25px; padding-right: 70px; " href="registration.php"><span class="glyphicon glyphicon-log-in"> SIGN-UP</span></a></li>
					</ul>
					<?php
				}
